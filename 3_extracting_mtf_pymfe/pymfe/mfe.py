...
class MFE:
    ...
    def __init__(self,
        ...
        """
        warnings.warn("This Pymfe source code is to guarantee reproducibility "
                      "in the experimental tests of the proposed pymfe expansi"
                      "on for time-series.\n   Please use only the updated ver"
                      "sion available at: https://github.com/ealcobaca/pymfe",
                      UserWarning)
